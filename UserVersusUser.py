...
class UserVersusUser(tk.Toplevel):
    def __init__(self,parent):
        ...
        self.label_Title = tk.Label(
            ...
            text=labelTitleText_UvU, # текст для надписи
        ...
        self.label_Title = tk.Label(
            self, # надпись создается в этом окне
            text=textRules_UvU, # текст для надписи
        ...
        self.message_label = tk.Label(
                ...
                font=('Arial', 12),
                fg="red",
                text ='Пусть первый игрок введет число.'
            )
    ...
    def checkAnswerU(self):
        ...
        # проверяем, ввел ли первый игрок число
        if self.secret_number == None:
            self.secret_number = user_answer
            self.show_message('Первый игрок ввел число. Второй игрок должен отгадать его.')
        else:
